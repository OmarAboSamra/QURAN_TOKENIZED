# Start Celery Worker for Qur'an Backend
# This script starts the Celery worker with all task queues

Write-Host "==================================" -ForegroundColor Cyan
Write-Host "   Celery Worker - Qur'an Backend" -ForegroundColor Cyan
Write-Host "==================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Queues: tokenization, root_extraction, maintenance" -ForegroundColor Cyan
